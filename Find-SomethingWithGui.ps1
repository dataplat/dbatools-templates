...
.EXAMPLE
Verb-DbaNoun -SqlServer sql2005 -FilePath C:\temp\sql2005-UnusedIndexes.sql
...
.EXAMPLE
Verb-DbaNoun -SqlServer sql2005 -FilePath C:\temp\sql2005-UnusedIndexes.sql -Append
